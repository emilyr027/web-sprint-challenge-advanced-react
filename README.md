...
(Stateful vs stateless components can also be known as container vs presntational components -- One has state and the other doesn't. Stateful components are keeping track of changing data while stateless components always render the same thing/they print out what is given to them via props
